...
- Изменить метод `process_payment(amount: double) -> bool`
  - Добавить параметр `currency: String = "USD"`
...
❌ **НЕ мокай вызовы LLM в тестах** — в каталоге tests в .env прописаны ключи, загружай переменные окружения, как в других тестах
