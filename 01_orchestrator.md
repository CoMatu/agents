...
6. Вести в файле status.md краткий статус по процессу: список этапов с отметками выполнения и список задач с отметками выполнения у казанием времени начала и завершения задачи.
